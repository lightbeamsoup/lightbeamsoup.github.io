...
test("energy reminder settings recover a recent slot from archived same-type evidence after widget ownership drifts", () => {
  const widget = {
    id: "energy-widget-current",
    type: "energy",
    settings: {
  ...
  const tasks = [
    ...
    {
      id: "energy-2-old",
      ownerWidgetId: "energy-widget-old",
      ownerWidgetType: "energy",
      ownerTaskKey: "energy-reminder-2",
      templateId: "energy-template-old",
      timeOfDay: "19:00",
      dueDate: "2026-04-04",
      status: "done",
      archived: true,
...
test("energy reminder settings recover a recent archived generated slot for the current widget", () => {
  const widget = {
    id: "energy-widget",
    type: "energy",
    settings: {
