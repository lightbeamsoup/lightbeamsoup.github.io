...
- 2026-04-04: Recover recurring Google master links from child occurrence evidence and resolve recurring calendar series/overrides from that evidence instead of trusting only the stale master link.
